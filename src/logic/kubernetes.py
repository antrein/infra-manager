...
def get_ns():
    try:
        ...
        non_project_ns = ["cert-manager", "default", "ingress-nginx", "kube-node-lease", "kube-public", "kube-system", "gke-managed-system", "gmp-public", "gmp-system", "production", "staging", "utils", "monitoring"]
